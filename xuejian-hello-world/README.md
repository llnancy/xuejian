...
- [在线网站创建](#在线网站创建)
- [IDEA 构建](#idea-构建)
  - [基于 Spring Initializr](#基于-spring-initializr)
  - [基于 Maven 创建](#基于-maven-创建)
  - [基于 Gradle](#基于-gradle)
- [编写启动类](#编写启动类)
- [编写 Controller](#编写-controller)
- [启动 Spring Boot](#启动-spring-boot)
...
运行 `XueJianHelloWorldApplication#main` 方法，访问 [http://localhost:8080/hello](http://localhost:8080/hello)。

完整代码可查看 [`Github`](https://github.com/llnancy/xuejian/tree/master/xuejian-hello-world)。
